# Udacity : Practice Questions 39 ---> my try (worked)
'''  
...
nom_count_dict = {}
# Add your code here
templist1=[y for x in nominated.values() for y in x ] #make list of dirs
      
for i in templist1:
    if i not in nom_count_dict.keys():
        nom_count_dict[i] = 1
    else :
        nom_count_dict[i] += 1
...
for i in templist2:
    if i not in win_count_dict.keys():
        win_count_dict[i] = 1
    else :
        win_count_dict[i] += 1
